...
app = Application(consumer_group="data_source", auto_create_topics=True, broker_address = "kafka_broker:19092")  # create an Application
...
def main():
    ...
    with app.get_producer() as producer:
        ...
        files = glob.glob('nasdaq_data/*.zst')
        files.sort()
